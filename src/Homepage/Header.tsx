  ...
  return (
    <div className="md:px-8 bg-forthPrimary pt-3 md:py-4 lg:py-6 border-b-[2px] border-black flex items-center text-center justify-between p-3">
      ...
      <ul className="">
        <li className="">
          {headerLink.map((link) => (
            <Link key={link.id} to={link.url} smooth className=" md:bg-black md:text-white md:hover:bg-white md:hover:text-black text-sm px-1 font-semibold font-display md:mr-2 md:px-5 md:text-sm md:py-2 lg:mr-4 lg:px-6 lg:py-2 xl:mr-4 xl:text-lg xl:px-8 xl:py-3 md:border-black md:border-[1px] rounded-full">
              {link.text}
            </Link>
          ))}
        </li>
