    ...
    <div className="">
      ...
      <div className="text-center px-4">
        ...
        <div className=" pt-12 md:pt-16 flex justify-center">
          <a href="/blog" className="px-5 py-3 2xl:py-4 2xl:px-8 2xl:text-2xl font-semibold md:text-xl font-display2 rounded-lg bg-black hover:bg-white hover:text-black text-white shadow-lg">See more</a>
        </div>
      </div>
    </div>
    </div>
