...
function HomeWeb() {
  return (
    <div className="marquee overflow-hidden">
      <Header />
      <div className="min-h-screen bg-heyhey min-w-full flex flex-col items-center bg-auto xl:bg-center justify-center py-16" style={{ backgroundImage: `url(${"backgroundImage"})`, }}>
