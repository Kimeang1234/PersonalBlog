...
function Aboutp() {
  return (
    <div className='flex pb-7 flex-col justify-between min-h-screen'>
      <Header />
      <div className=" px-10 md:pb-10">
       <div className="pb-7 md:pb-10 lg:pb-13 xl:pb-16">
         <h1 className="text-5xl md:text-6xl xl:text-7xl">About</h1>
          <h2 className='text-3xl md:text-4xl xl:text-5xl md:pt-2 pb-4'>Me</h2>
